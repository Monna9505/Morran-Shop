...
?>
<div class="textbox__and__img" <?php echo !empty($ti_section_id) ? 'id=' . $ti_section_id : ''; ?>>
    <div class="container">
        ...
        <?php if (!empty($textbox_image_repeater) && is_array($textbox_image_repeater)) { ?>
            <div class="textbox__image__repeater standard-grid">
                <?php foreach ($textbox_image_repeater as $index => $item) { 
                    ...
                    $link = (isset($item['service_link']['url']) && !empty($item['service_link']['url'])) ? $item['service_link']['url'] : 'javascript(0):void';
                ?>
                    <div class="service <?php echo $zigzag_class; ?>">
                        <div class="textbox__wrapper">
                            <a href="<?php echo $link; ?>" class="textbox__content <?php echo $has_link; ?>">
