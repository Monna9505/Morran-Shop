...
?>
<section class="page__break" data-parallax <?php echo ($image_or_video == 'image' && !empty($background_image_pb['url'])) ? 'style="background:url(' . htmlspecialchars($background_image_pb['url']) . ') no-repeat center; background-size: cover;"' : ''; ?>>
